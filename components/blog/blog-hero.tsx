    ...
    <section className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950/20 dark:to-indigo-950/20 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-balance">Blog Blockchain Insper</h1>
          ...
          <div className="max-w-md mx-auto mb-12">
            <div className="relative">
              ...
              <Input placeholder="Buscar artigos..." className="pl-10 pr-4 py-3 text-base" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground">Posts por Semana</div>
            </div>
          </div>
        </div>
      </div>
